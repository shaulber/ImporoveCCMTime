...

    {
        ...
        private DataRow AddRow(Component component)
        {
            ...
            dr["Primaryhost"] = ""; 
             ...
             dr["ParimaryDbHost"] = ""; 
             dr["SecondaryDBHost"] = ""; 
            dr["State"] = component.Attributes.GetAttribueValue(Attributes.CurrentState); 
             dr["DesiredState"] = "";
            dr["Message"] = "";
             dr["LastChecked"] = ""; 
             dr["OS"] = component.Attributes.GetAttribueValue(Attributes.OSType);
            dr["Version"] = component.Attributes.GetAttribueValue(Attributes.Version); 
            dr["HasHa"] =""; 
            return dr;
        }
